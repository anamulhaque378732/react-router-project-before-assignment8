        ...
        <div className="">
            <div className="navbar bg-base-100 shadow-lg px-4    z-10">
                <div className="flex-1">
                    <Link to={'/'} className="btn btn-ghost text-2xl  text-secondary gap-0 normal-case font-bold">Byte<span className="text-primary">Blaze</span></Link>
                </div>
                <div className="flex-none text-2xl  mb-5">
                    ...
                    <label className="grid cursor-pointer ml-2 place-items-center">
