    ...
    return (
        <section className="dark:bg-gray-100 dark:text-gray-800">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                ...
                <div className="grid justify-center  md:grid-cols-2 gap-6 sm:grid-cols-1 lg:grid-cols-3">
                    {
                        blogs.slice(1, 19).map(blog => <BlogCard deletable={true}  key={blog.id} blog={blog}></BlogCard>)
                    }
